    ...
    <div class="section-box-1">
        ...
        <div id="map_cloud" style="display: none;">
            <script type="text/javascript">
                function initialize() {
                    var start_position = new google.maps.LatLng('38.69', '41.02');
                    var settings = {
                        zoom: 3,
                        scrollwheel: false,
                    ...
                    var image1 = new google.maps.MarkerImage('design/images/markers/marker-we-1.png',
                    ...
                    var image10 = new google.maps.MarkerImage('design/images/markers/marker-empl-1.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image11 = new google.maps.MarkerImage('design/images/markers/marker-empl-2.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image12 = new google.maps.MarkerImage('design/images/markers/marker-empl-3.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image13 = new google.maps.MarkerImage('design/images/markers/marker-empl-4.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image14 = new google.maps.MarkerImage('design/images/markers/marker-empl-5.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image15 = new google.maps.MarkerImage('design/images/markers/marker-empl-6.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image16 = new google.maps.MarkerImage('design/images/markers/marker-empl-7.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image17 = new google.maps.MarkerImage('design/images/markers/marker-empl-8.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    var image18 = new google.maps.MarkerImage('design/images/markers/marker-empl-9.png',
                            new google.maps.Size(21, 32),
                            new google.maps.Point(0,0),
                            new google.maps.Point(16, 35)
                    );
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        map: map,
                        title: '<?= $models->title ?>',
                        icon: image<?= $models->coordenats->category_map ?>
                    });
                    <?php if($a == 1): ?>
                    markers.push(marker);
                     var infowindow = new google.maps.InfoWindow({
                        content: '<div style="width: 112px;"><a href="#" style="text-decoration: none; color: #333"><img style="width: 112px; height: 60px" src="<?= $models->image1 ?>" alt=""/><p style="width: 100%; text-align: center; font-family: Ubuntu Bold; font-size: 11px;"><?= $models->title ?></p></a></div>'
                    });
...
//балун
                    ...
                    <?php foreach($model as $models): ?>
                        <li>
                            <a
                                ...
                                href="/portfolio/portfolio_detail/<?= $models->seo->slug ?>" class="slider_a"
                                <?php else: ?>
                                href="/portfolio/portfolio_detail/<?= $models->id ?>" class="slider_a"
                                <?php endif; ?>
                            >
                                <div class="slider-marker-bl">
                                    <div class="slider-marker-bl-img">
                                        <img src="<?= $models->image1 ?>" alt="" style=" width: 100px; height: 82px;"/>
                                    </div>
    ...
    <div class="section-box-2">
        <div class="form-first-text">Проектная компания №1 в Украине</div>
    ...
    <div class="section-box-3">
          ...
          <div class="portfolio-foto-wrapp">
              <div class="portfolio-foto">
                  <a href="#" class="portfolio-foto-blocks all-jobs" >
                ...
                <?php foreach($portfolioall as $portfolios): ?>
                  <a
                      ...
                      href="/portfolio/portfolio_detail/<?= $portfolios->seo->slug ?>" class="portfolio-foto-blocks portf_dynamic" id="portfolio-foto-b<?= $i ?>"
                      <?php else: ?>
                      href="/portfolio/portfolio_detail/<?= $portfolios->id ?>" class="portfolio-foto-blocks portf_dynamic" id="portfolio-foto-b<?= $i ?>"
                      <?php endif; ?>
                  >
                          
                      <div class="portfolio-foto-blocks-img"><img src="<?= $portfolios->image1 ?>" alt=""/></div>
